...
const deleteRecipe = async (req, res) => {
  try {
    ...
    if (recipe.imageId) {
      await cloudinary.uploader.destroy(recipe.imageId)
    }
...
module.exports = { addRecipe, getMyRecipes, getRecipes, getAllRecipes, deleteRecipe, getSingleRecipe, toggleLike, getRecipesByIngredient, getRecipesByCuisine, getTopRecipes };
